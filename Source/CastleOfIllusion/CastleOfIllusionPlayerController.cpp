...
ACastleOfIllusionPlayerController::ACastleOfIllusionPlayerController()
{
	bShowMouseCursor = true;
	DefaultMouseCursor = EMouseCursor::Crosshairs;
}

void ACastleOfIllusionPlayerController::PlayerTick(float DeltaTime)
{
...
void ACastleOfIllusionPlayerController::SetupInputComponent()
{
...
void ACastleOfIllusionPlayerController::MoveToMouseCursor()
{
	if (UHeadMountedDisplayFunctionLibrary::IsHeadMountedDisplayEnabled())
	{
		if (ACastleOfIllusionCharacter* MyPawn = Cast<ACastleOfIllusionCharacter>(GetPawn()))
		{
...
void ACastleOfIllusionPlayerController::MoveToTouchLocation(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
void ACastleOfIllusionPlayerController::SetNewMoveDestination(const FVector DestLocation)
{
...
void ACastleOfIllusionPlayerController::OnSetDestinationPressed()
{
	// set flag to keep updating destination until released
	bMoveToMouseCursor = true;
}

void ACastleOfIllusionPlayerController::OnSetDestinationReleased()
{
